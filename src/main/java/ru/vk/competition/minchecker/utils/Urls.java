...
public interface Urls {
    ...
    String DELETE_SINGLE_QUERY_BY_ID = "delete-single-query-by-id/{id}";

    String EXECUTE_SINGLE_QUERY_RESULT = "add-execute-result";
    String EXECUTE_SINGLE_QUERY_BY_ID = "execute-single-query-by-id/{id}";

    String GET_SINGLE_QUERY_BY_ID = "get-single-query-by-id/{id}";
